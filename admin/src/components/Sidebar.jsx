  ...
  return (
    <div className='w-[18%] min-h-screen border-r-2'>
      <div className='flex flex-col gap-4 pt-6 pl-[20%] text-[15px]'>
        ...
        <NavLink className='flex items-center gap-3 border border-gray-300 border-r-0 px-3 py-2 rounded-1 hover:scale-110 hover:bg-gray-300' to="chatpresets">
            <img className='w-5 h-5' src={assets.chat_icon} alt="" />
            <p className='hidden md:block'>Chat Presets</p>
        </NavLink>
      </div>
    </div>
  )
