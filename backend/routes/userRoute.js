...
import { loginUser, registerUser, adminLogin, getUserProfile, editUserProfile, verifyOTP, qrLogin } from "../controllers/userController.js";
...
userRouter.post('/qrlogin', qrLogin);
